...
const EmployedmentBoard = ({ handleSidebarButtonClick }) => {
  // 반응형 화면
            ...
            <div style={{flex: '1', marginTop:'40px', marginLeft:'40px', marginRight:'40px'}}>
              <div>
                <div>
                  {isMobile && 
                  <div>
                    <div className={style.head} style={{fontSize: isDesktopOrLaptop ? '25px' : '20px', marginBottom:'10px' }}>취업 글 목록</div>
                    <Searchbar defaultSearchText="제목 및 내용으로 검색" onSearch={handleSearch}/>
                  </div>}
                  {!isMobile && <div className={style.background_head}>
                    <div className={style.head} style={{fontSize: isDesktopOrLaptop ? '25px' : '20px' }}>취업 글 목록</div>
                    <Searchbar defaultSearchText="제목 및 내용으로 검색" onSearch={handleSearch}/>
                  </div>}
...
export default EmployedmentBoard;
