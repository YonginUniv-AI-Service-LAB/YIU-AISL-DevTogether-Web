...
const SignUpPage = ( ) => {
  ...
  const handleRegister = () => {
    ...
    if (email && password && name && nickname && gender && age && role && question && answer) {
      // 모든 필드가 채워졌을 때 실행할 함수 호출
      console.log("모든 필드가 채워졌습니다. 회원가입을 진행합니다...");
      console.log( password, email, name, nickname, gender, age, role, question, answer )
  ...
  return (
    <div style={{
      ...
      <div className={style.register}  style={{ marginLeft: isMobile ? 0 : isTablet ? 100 : 100}}>
